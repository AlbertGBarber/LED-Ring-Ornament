...
const PROGMEM segmentSection halfSec0[] = { {0, 12}, {24, 8}, {40, 6}, {52, 4}, {60, 1} };
Segment halfSegment0 = { SIZE(halfSec0), halfSec0, true }; //numSections, section array pointer

const PROGMEM segmentSection halfSec1[] = { {12, 12}, {32, 8}, {46, 6}, {56, 4}, {60, 1} };
